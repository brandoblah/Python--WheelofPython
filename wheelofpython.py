...
class WOFHumanPlayer(WOFPlayer):
    def getMove(self, category, obscured, guessed):
        user_input = '''{} has ${}
        Category: {}
        Phrase:  {}
        Guessed: {}
        ...
        '''.format(self.name, self.prizeMoney, category, obscured, guessed)
        print(user_input)
...
class WOFComputerPlayer(WOFPlayer):
    ...
    def getMove(self, category, obscured, guessed):
        ...
        if self.getPossibleLetters(guessed) == []:
            ...
            self = random.choice(self.getPossibleLetters(guessed))
            return self
